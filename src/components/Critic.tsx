  ...
  return (
    <article className="mx-auto max-w-4xl px-6 py-16 lg:px-0">
      <header className="mb-16 animate-fade-in">
        ...
        <p className="mt-6 max-w-2xl font-serif text-lg leading-relaxed text-museum-cream/70">
      ...
      <div className="space-y-20">
        {criticVerdicts.map((verdict, index) => {
          ...
          return (
            ...
            >
              <p className="font-serif text-sm uppercase tracking-[0.25em] text-museum-muted">
                {verdict.eyebrow}
              </p>
              ...
              >
                <div className="md:w-2/5">
                  ...
                  <div className="mt-4 font-serif text-sm tracking-wide text-museum-muted">
                    <p className="text-museum-cream/90">{art.title}</p>
                    <p className="mt-1 italic">{art.artist}</p>
                    <p className="mt-1 text-museum-muted/80">{art.modelId}</p>
                  </div>
                </div>
                ...
                <div className="md:w-3/5">
                  ...
                  <div className="mt-5 space-y-4 font-serif text-lg leading-relaxed text-museum-cream/70">
      ...
      <p className="mt-20 border-t border-museum-border pt-8 text-center font-serif text-sm italic text-museum-muted">
