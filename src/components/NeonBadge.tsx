export function NeonBadge() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-40 flex items-center gap-2 rounded-full border border-museum-border bg-museum-charcoal/90 px-4 py-2.5 backdrop-blur-sm transition-all hover:border-neon-green/40 hover:bg-museum-plaque"
